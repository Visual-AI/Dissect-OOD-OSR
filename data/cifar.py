...
def get_cifar_10_100_datasets(train_transform, test_transform, train_classes=(0, 1, 8, 9), open_set_classes=range(10), balance_open_set_eval=False, split_train_val=True, seed=0):
...
def get_cifar_10_10_datasets(train_transform, test_transform, train_classes=range(4), open_set_classes=range(4, 10), balance_open_set_eval=False, split_train_val=True, seed=0):
