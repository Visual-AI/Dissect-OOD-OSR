...
osr_split_save_dir = os.path.join(osr_split_dir, 'imagenet21k_osr_splits.pkl')
...
def get_image_net_datasets(train_transform, test_transform, train_classes=range(1000),
    ...
    test_dataset_unknown = ImageNetBase(root=os.path.join(imagenet21k_root, 'imagenet21k_val'), transform=test_transform)
