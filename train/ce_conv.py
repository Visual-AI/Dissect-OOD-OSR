...
from methods import train, test_id
...
if __name__ == '__main__':
    ...
    if args.mixup:
        args.ablation = '{}_Mixup'.format(args.ablation)
    ...
    for epoch in range(args.epochs):
        train(net, criterion, optimizer, warmup_scheduler, trainloader, epoch, optimizer_h=optimizer_h, **options)
